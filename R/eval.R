...
##' @param envir the environment in which to evaluate the code (by
##' default the global environment; if we do not want to mess up with
##' the global environment, we can set \code{envir = NULL} or
##' \code{envir = new.env()})
