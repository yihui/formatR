\documentclass[noae,nogin]{article}
...
\hspace*{\fill}\\
\hlstd{}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlfunctioncall{usage}\hlkeyword{(}\hlsymbol{tidy.source}\hlkeyword{)}\mbox{}
\normalfont
...
\begin{Schunk}
\begin{Hinput}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlfunctioncall{options}\hlkeyword{(}\hlargument{keep.blank.line}{\ }\hlargument{=}{\ }\hlnumber{TRUE}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }not{\ }really{\ }need{\ }to{\ }do{\ }so;{\ }default{\ }is{\ }TRUE}\mbox{}
\normalfont
...
\begin{Schunk}
\begin{Hinput}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlfunctioncall{options}\hlkeyword{(}\hlargument{width}{\ }\hlargument{=}{\ }\hlnumber{85}\hlkeyword{)}\mbox{}
\normalfont
...
\hspace*{\fill}\\
\hlstd{}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlsymbol{src}{\ }\hlassignement{=}{\ }\hlfunctioncall{c}\hlkeyword{(}\hlstring{"{\ }{\ }{\ }{\ }\usebox{\hlnormalsizeboxhash}{\ }a{\ }single{\ }line{\ }of{\ }comments{\ }is{\ }preserved"}\hlkeyword{,}{\ }\hlstring{"1+1"}\hlkeyword{,}{\ }\hlstring{"if(TRUE)\usebox{\hlnormalsizeboxopenbrace}"}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}\hlprompt{+{\ }}{\ }{\ }{\ }{\ }\hlstring{"x=1{\ }{\ }\usebox{\hlnormalsizeboxhash}{\ }inline{\ }comments"}\hlkeyword{,}{\ }\hlstring{"\usebox{\hlnormalsizeboxclosebrace}else\usebox{\hlnormalsizeboxopenbrace}"}\hlkeyword{,}{\ }\hlstring{"x=2;print(\usebox{\hlnormalsizeboxsinglequote}Oh{\ }no...{\ }ask{\ }the{\ }right{\ }bracket{\ }to{\ }go{\ }away!\usebox{\hlnormalsizeboxsinglequote})\usebox{\hlnormalsizeboxclosebrace}"}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}\hlprompt{+{\ }}{\ }{\ }{\ }{\ }\hlstring{"1*3{\ }\usebox{\hlnormalsizeboxhash}{\ }one{\ }space{\ }before{\ }this{\ }comment{\ }will{\ }become{\ }two!"}\hlkeyword{,}{\ }\hlstring{"2+2+2{\ }{\ }{\ }{\ }\usebox{\hlnormalsizeboxhash}{\ }\usebox{\hlnormalsizeboxsinglequote}short{\ }comments\usebox{\hlnormalsizeboxsinglequote}"}\hlkeyword{,}\hspace*{\fill}\\
...
\begin{Schunk}
\begin{Hinput}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlfunctioncall{tidy.source}\hlkeyword{(}\hlargument{text}{\ }\hlargument{=}{\ }\hlsymbol{src}\hlkeyword{,}{\ }\hlargument{replace.assign}{\ }\hlargument{=}{\ }\hlnumber{TRUE}\hlkeyword{)}\mbox{}
\normalfont
...
\begin{Schunk}
\begin{Hinput}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlcomment{\usebox{\hlnormalsizeboxhash}\usebox{\hlnormalsizeboxhash}{\ }note{\ }the{\ }11th{\ }line{\ }(was{\ }a{\ }blank{\ }line)!}\mbox{}
\normalfont
\hspace*{\fill}\\
\hlstd{}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlfunctioncall{tidy.source}\hlkeyword{(}\hlargument{text}{\ }\hlargument{=}{\ }\hlsymbol{src}\hlkeyword{,}{\ }\hlargument{keep.blank.line}{\ }\hlargument{=}{\ }\hlnumber{FALSE}\hlkeyword{)}\mbox{}
\normalfont
