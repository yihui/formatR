...
\end{Soutput}
\begin{Hinput}\ttfamily\noindent
\hlprompt{\usebox{\hlnormalsizeboxgreaterthan}{\ }}\hlcomment{\usebox{\hlnormalsizeboxhash}\usebox{\hlnormalsizeboxhash}{\ }the{\ }formatted{\ }version{\ }(with{\ }\usebox{\hlnormalsizeboxsinglequote}=\usebox{\hlnormalsizeboxsinglequote}{\ }replace{\ }by{\ }\usebox{\hlnormalsizeboxsinglequote}\usebox{\hlnormalsizeboxlessthan}-\usebox{\hlnormalsizeboxsinglequote})}\mbox{}
\normalfont
\hspace*{\fill}\\
\hlstd{}\ttfamily\noindent
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.85\linewidth]{formatR-GUI-1.png}\medskip{}

\par\end{centering}

\begin{centering}
\includegraphics[width=0.85\linewidth]{formatR-GUI-2.png}
\par\end{centering}
