...
You can install **formatR** from [CRAN](http://cran.rstudio.com/package=formatR), or [RForge](http://rforge.net/formatR) if you want to test the latest development version:
